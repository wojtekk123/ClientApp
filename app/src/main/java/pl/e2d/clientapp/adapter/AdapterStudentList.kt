...
class AdapterStudentList(val context: Context, val list: List<Student>) : BaseAdapter() {
...
class AdapterStudentPopUpList(val context: Context, val list: List<String?>) : BaseAdapter() {
...
class AdapterStudentPopUpAdd(val context: Context, val list: List<String>) : BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View = LayoutInflater.from(context).inflate(R.layout.adapter_vie_popup_list, parent, false)
